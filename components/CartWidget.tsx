...
export default function CartWidget() {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-6 right-6 z-40 flex rounded-full border border-electric-yellow/30 bg-[#121212]/95 p-3 shadow-[0_0_30px_rgba(255,204,0,0.2)] backdrop-blur-md sm:bottom-8 sm:right-8 sm:p-4"
    >
      <Link href="/cart" className="group inline-flex items-center gap-3 text-sm font-bold uppercase tracking-[0.2em] text-white transition-colors hover:text-electric-yellow">
        <span className="relative flex h-10 w-10 items-center justify-center rounded-full bg-electric-yellow text-black transition-transform group-hover:scale-110 sm:h-12 sm:w-12">
          ...
          <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-600 text-[10px] font-bold text-white outline outline-2 outline-[#121212]">
            2
          </span>
        </span>
