      ...
      <AnimatePresence>
        {visible && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex items-center justify-center bg-[#050505]/95 backdrop-blur-xl p-6 text-white"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            >
              <div className="space-y-6 text-center">
                ...
                <h2 id="age-gate-title" className="text-4xl font-display tracking-tight text-white">
                  ¿Eres mayor de 18 años?
                </h2>
                <p id="age-gate-description" className="text-base leading-7 text-slate-300">
                  La venta y promoción de bebidas alcohólicas en España está regulada. Debes confirmar que tienes 18
                  años o más para acceder a Vermut El Travieso.
                </p>
                <p className="text-xs text-slate-500">Bebe con moderación. Prohibida la venta a menores.</p>
      ...
      {blocked && !visible ? (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#050505] p-6 text-center text-white">
          <div className="max-w-md space-y-4">
            ...
            <p className="text-slate-400">Debes ser mayor de 18 años para visitar este sitio.</p>
            <button
              type="button"
              onClick={() => {
              ...
              className="rounded-full border border-white/20 px-6 py-3 text-xs font-bold uppercase tracking-widest text-slate-300"
            >
              Volver a verificar edad
            </button>
          </div>
        </div>
      ) : null}
